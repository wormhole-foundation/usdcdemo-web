  ...
  return (
    <EthereumProviderProvider>
      <Layout>
        ...
        <Container
          maxWidth="lg"
          sx={{ my: 10, textAlign: { xs: "center", md: "left" } }}
        >
          <Box sx={{ mb: SECTION_SPACING }}>
            ...
            <Typography align="center" maxWidth="430px" margin="auto">
              Wormhole’s integration with Circle lets developers compose generic
              messages with Cross-Chain Transfer Protocol (CCTP) USDC transfers.
            </Typography>
          </Box>
          <Box
            sx={{
          ...
          >
            ...
            <Box sx={{ mb: 3, minWidth: { md: "542px" } }}>
              ...
              <Typography>
                ...
                powering interactions like native, cross-chain swaps between ETH
                and AVAX.
              </Typography>
            </Box>
          </Box>
          ...
          <Box>
            <Typography sx={{ mb: 2 }}>
              ...
              on the <NoSplit>cutting-edge of cross-chain.</NoSplit>
            </Typography>
            <Button
