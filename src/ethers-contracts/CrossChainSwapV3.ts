...
export interface CrossChainSwapV3Interface extends utils.Interface {
  functions: {
...
export interface CrossChainSwapV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrossChainSwapV3Interface;
